...
public class AuthV3Util {
     ...
     */
    public static void addAuthParams(String appKey, String appSecret, Map<String, List<String>> paramsMap)
            throws NoSuchAlgorithmException {
        List<String> qArray = paramsMap.get("q");
        if (qArray == null) {
        ...
        paramsMap.put("appKey", Lists.newArrayList(appKey));
        paramsMap.put("salt", Lists.newArrayList(salt));
        paramsMap.put("curtime", Lists.newArrayList(curtime));
        paramsMap.put("signType", Lists.newArrayList("v3"));
        paramsMap.put("sign", Lists.newArrayList(sign));
    }
