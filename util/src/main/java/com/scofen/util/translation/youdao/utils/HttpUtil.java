package com.scofen.util.translation.youdao.utils;
...
public class HttpUtil {
    ...
    public static byte[] doGet(String url, Map<String, String[]> header, Map<String, List<String>> params, String expectContentType) {
    ...
    public static byte[] doPost(String url, Map<String, String[]> header, Map<String, List<String>> body, String expectContentType) {
    ...
    private static void addUrlParam(Request.Builder builder, String url, Map<String, List<String>> params) {
        if (params == null) {
            return;
        }
    ...
    private static void addBodyParam(Request.Builder builder, Map<String, List<String>> body, String method) {
        if (body == null) {
            return;
        }
