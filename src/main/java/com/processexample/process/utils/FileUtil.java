...
public class FileUtil {
    ...
    public static ResultUtil upload(HttpServletRequest request, String userToken, List<MultipartFile> files) throws Exception {
        init();
    ...
    public static ResultUtil upload(HttpServletRequest request, List<MultipartFile> files)  throws Exception{
