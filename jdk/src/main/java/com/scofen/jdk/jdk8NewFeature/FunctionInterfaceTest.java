...
//Java 8 允许你使用 :: 关键字来传递方法(静态方法和非静态方法)
    ...
    public  void testDouble() {
        ...
        aa3 = FunctionInterfaceTest::Double2;
...
//-------------------------------------------------------------------------------------------------------------------------------
    ...
    public interface Function<T, R> {
        ...
        //那么f.apply("classLoader") 返回字符串"classLoader"
        //传入什么则返回什么
    ...
    public interface IFunction<T, R> {
        ...
        public R select(T t, Function<T, R> function);

        public Student get1(String key);

        public Student get2(Integer age);

    }

    class IFunctionImpl implements IFunction {

        @Override
        public Object select(Object o, Function function) {
            return function.apply(o);
        }

        @Override
        public Student get1(String key) {
            return (Student) this.select(key, object -> new Student(key));
        }

        @Override
        public Student get2(Integer age) {
            return (Student) this.select(age, object -> new Student(String.valueOf(age)));
        }
    ...
    public void testFunction2() {
        ...
        System.out.println(JSON.toJSONString(iFunction.get1("student1")));
        System.out.println(JSON.toJSONString(iFunction.get2(10)));
    }
