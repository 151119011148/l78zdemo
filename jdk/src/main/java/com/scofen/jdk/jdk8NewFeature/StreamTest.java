...
/*        输出结果:
        ...
        List<String> list = Arrays.asList("classLoader", "hello", "world", "java", "tom", "C", "javascript");
...
*/
        List<String> list2 = Arrays.asList("classLoader", "hello", "world", "java", "tom", "C", "javascript");
...
/*        最后list2中就存放的筛选出来的元素
        ...
        List<String> list5 = Arrays.asList("classLoader", "hello", "world");
...
//任意一个匹配成功就返回true 否则返回false
        ...
        List<String> list1 = Arrays.asList("classLoader", "hello", "world", "java", "tom", "C", "javascript");
...
//没有一个匹配的就返回true 否则返回false
    ...
    */
    ...
    public void testReduce() {
        ...
        List<String> list = Arrays.asList("classLoader", "javap", "hello", "world", "java", "tom", "C", "javascript");
...
//找出字符文件中字符字符最长的一行
        BufferedReader br = new BufferedReader(new FileReader("src/com/briup/classLoader/a.txt"));
        int maxLen = br.lines().
